<script lang="ts">
  ...
  import IconDisconnect from "./lib/icons/IconDisconnect.svelte";
        ...
        <div class="flex flex-1">
          <div class="w-[90vh] mr-4">
            <button on:click={openMap} class="bg-neutral-800 rounded-lg flex flex-col items-center justify-center h-full w-full relative overflow-hidden transition-all duration-300 hover:bg-neutral-900">
              <img src="assets/map/map.png" alt="Map" class="h-[70vh] w-[90vh] opacity-20 rounded-lg transition-transform duration-300 transform hover:scale-105"/>
            </button>
          </div>  
